...
describe('PluginInstaller', () => {
  ...
  describe('InstallerError', () => {
    it('should create error with all properties', () => {
      ...
      const error = new InstallerError('Installation failed', 'INSTALL_FAILED', cause);
    ...
    it('should create error without cause', () => {
      const error = new InstallerError('Installation failed', 'INSTALL_FAILED');
  ...
  describe('Error Codes', () => {
    it('should use ALREADY_INSTALLED error code', () => {
      const error = new InstallerError('Plugin already installed', 'ALREADY_INSTALLED');
...
describe.skip('PluginInstaller Integration Tests', () => {
  ...
  it('should verify integrity of downloaded file', async () => {
    ...
    await expect(installer.verifyIntegrity(filePath, shasum)).rejects.toThrow(InstallerError);
  }, 30000);
  ...
  it('should install and uninstall a plugin', async () => {
    ...
    // Install
    const result = await installer.install('@sessionry/plugin-test', metadata, manifest, {
      skipValidation: true
    });

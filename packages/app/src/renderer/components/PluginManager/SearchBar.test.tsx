...
describe('SearchBar', () => {
  ...
  it('debounces search calls', () => {
    ...
    render(<SearchBar value="" onChange={onChange} onSearch={onSearch} debounceMs={500} />);
  ...
  it('disables input when disabled prop is true', () => {
    ...
    render(<SearchBar value="" onChange={onChange} onSearch={onSearch} disabled={true} />);
  ...
  it('disables clear button when disabled prop is true', () => {
    ...
    render(<SearchBar value="test" onChange={onChange} onSearch={onSearch} disabled={true} />);
  ...
  it('auto-focuses input when autoFocus is true', () => {
    ...
    render(<SearchBar value="" onChange={onChange} onSearch={onSearch} autoFocus={true} />);
  ...
  it('cancels pending debounce on clear', () => {
    ...
    const { rerender } = render(
      <SearchBar value="" onChange={onChange} onSearch={onSearch} debounceMs={500} />
    );
    ...
    // Rerender with value
    rerender(<SearchBar value="test" onChange={onChange} onSearch={onSearch} debounceMs={500} />);

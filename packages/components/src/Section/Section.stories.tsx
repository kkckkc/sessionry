  ...
  render: () => {
    ...
    return (
      <div style={{ minWidth: '400px' }}>
        <Section title="Preferences" description="Configure your application preferences">
          <Toggle
            label="Enable notifications"
            checked={notifications}
            onChange={setNotifications}
          />
          <Toggle label="Auto-save changes" checked={autoSave} onChange={setAutoSave} />
          <Toggle label="Send anonymous analytics" checked={analytics} onChange={setAnalytics} />
        </Section>
      </div>
    );
  }
...
export const WithInputs: Story = {
  render: () => {
    ...
    return (
      <div style={{ minWidth: '400px' }}>
        <Section title="Project Information" description="Basic details about your project">
...
export const WithSelects: Story = {
  render: () => {
    ...
    return (
      <div style={{ minWidth: '400px' }}>
        <Section title="Display" description="Customize how the application looks">
          <Select label="Theme" options={themeOptions} value={theme} onChange={setTheme} />
          <Select
            label="Language"
  ...
  render: () => {
    ...
    return (
      <div style={{ minWidth: '400px' }}>
        ...
        >
          <Toggle label="Enable development server" checked={enabled} onChange={setEnabled} />
          <Select
            label="Protocol"
  ...
  render: () => {
    ...
    return (
      ...
      >
        ...
        <Section title="Notifications" description="Manage notification preferences">
          <Toggle
            label="Enable notifications"
            checked={notifications}
            onChange={setNotifications}

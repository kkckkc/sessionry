  ...
  render: args => {
    ...
    return (
      <div style={{ minWidth: '300px' }}>
        <Select {...args} options={themeOptions} value={value} onChange={setValue} />
      </div>
    );
  },
  args: {
...
export const WithDescription: Story = {
  render: args => {
    ...
    return (
      <div style={{ minWidth: '300px' }}>
        <Select {...args} options={languageOptions} value={value} onChange={setValue} />
      </div>
    );
  },
  args: {
  ...
  render: args => {
    ...
    return (
      <div style={{ minWidth: '300px' }}>
        <Select
          {...args}
          options={[{ value: '', label: 'Select an option...' }, ...themeOptions]}
          value={value}
          onChange={setValue}
        />
      </div>
  ...
  render: args => {
    ...
    return (
      <div style={{ minWidth: '200px' }}>
        <Select {...args} options={fontSizeOptions} value={value} onChange={setValue} />
      </div>
    );
  }
};
...
export const ManyOptions: Story = {
  render: args => {
    ...
    return (
      <div style={{ minWidth: '300px' }}>
        <Select {...args} options={countryOptions} value={value} onChange={setValue} />
      </div>
    );
  },
  args: {

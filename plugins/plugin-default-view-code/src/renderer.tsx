...
const CodePaneView = ({
  ...
  const languagePath =
    typeof pane.state.languagePath === 'string' ? pane.state.languagePath : filePath;
  ...
  useEffect(() => {
    ...
    const previewKeymap = isMarkdown
      ? keymap.of([
          {
            key: 'Mod-Shift-v',
            preventDefault: true,
  ...
  return React.createElement(
    ...
    status === 'loading'
      ...
      : null,
    isSaving ? React.createElement('div', { className: 'code-pane-status' }, 'Saving…') : null,
    errorMessage
